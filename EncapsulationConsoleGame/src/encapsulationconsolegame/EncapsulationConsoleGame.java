 ...
 * @author ASUS
 */
public class EncapsulationConsoleGame extends Lainnya{
    ...
    public static void main(String[] args) {
        ...
        if(jenisMember == "Silver") {
            ...
            System.out.println("| Jumlah Cashback              | : Rp. " + memGold.getCashBack());
            ...
            System.out.println("| Jumlah Cashback              | : Rp. " + memPlat.getCashBack());
